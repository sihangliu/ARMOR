...
art = []
art.append(lgd)
plt.savefig('kmeans_error_cdf.png', additional_artists=art, bbox_inches='tight', dpi=400)
#plt.savefig('kmeans_error_cdf.pdf', additional_artists=art, bbox_inches='tight')
